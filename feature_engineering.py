...
# TODO:REW, can be replaced with list comprehension
...
# TODO:REW, can be replaced with sklearn/pandas methods
def read_fake_news_data_set(xl_file):
    ...
    for i, _ in enumerate(dirty_fake_news_outlets):
...
# TODO:REW, can be replaced with sklearn methods
...
see_lengths('real_news_urls-training.txt')
